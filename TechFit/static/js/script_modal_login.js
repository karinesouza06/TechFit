...
document.addEventListener('DOMContentLoaded', () => {
    ...
    emailInput.addEventListener('input', () => resetErrors());
    passwordInput.addEventListener('input', () => resetErrors());
});

document.querySelector('.register a[href="#cadastro"]').addEventListener('click', (e) => {
    document.getElementById('modal-1').close(); // Fecha o modal
});